...
![Snipaste_2022-03-20_19-39-27](https://raw.githubusercontent.com/simoonp/upgit_picture/main/2022/03/upgit_20220320_1647776405.png)

![Snipaste_2022-03-20_19-40-20](https://raw.githubusercontent.com/simoonp/upgit_picture/main/2022/03/upgit_20220320_1647776425.png)
...
```c
  while (1)
  {
	...
	HAL_GPIO_WritePin(GPIOD, GPIO_PIN_2, GPIO_PIN_SET); 	// 打开PD2 锁存器
	HAL_GPIO_WritePin(GPIOD, GPIO_PIN_2, GPIO_PIN_RESET);
    /* USER CODE BEGIN 3 */
  }
```
...
![timer](https://raw.githubusercontent.com/simoonp/upgit_picture/main/2022/03/upgit_20220320_1647776896.png)
...
2、初始化引脚为中断模式 `HAL_GPIO_Init()`

3、配置GPIO中断优先级 `HAL_NVIC_SetPriority()`

4、开启中断 `HAL_NVIC_EnableIRQ()`

5、在中断触发作用下自动指向中断函数 `EXTI0_IRQHandler()`

6、再次判断GPIO是否产生中断标志，如果产生，中断回调 `HAL_GPIO_EXTI_IRQHandler()` -> `HAL_GPIO_EXTI_Callback()`

7、指向中断回调的功能 `HAL_GPIO_EXTI_Callback()`

### USART串口

![image-20220321154626733](https://raw.githubusercontent.com/simoonp/upgit_picture/main/2022/03/upgit_20220321_1647848787.png)

![发送](https://raw.githubusercontent.com/simoonp/upgit_picture/main/2022/03/upgit_20220321_1647849006.png)

![接收](https://raw.githubusercontent.com/simoonp/upgit_picture/main/2022/03/upgit_20220321_1647849522.png)

### USART1串口配置

![image-20220321162018327](https://raw.githubusercontent.com/simoonp/upgit_picture/main/2022/03/upgit_20220321_1647850818.png)

![image-20220321162123148](https://raw.githubusercontent.com/simoonp/upgit_picture/main/2022/03/upgit_20220321_1647850883.png)

![image-20220321162258364](C:\Users\MOON\AppData\Roaming\Typora\typora-user-images\image-20220321162258364.png)

![image-20220321162413090](https://raw.githubusercontent.com/simoonp/upgit_picture/main/2022/03/upgit_20220321_1647851053.png)

![image-20220321162504355](https://raw.githubusercontent.com/simoonp/upgit_picture/main/2022/03/upgit_20220321_1647851104.png)
...
芯片频率/PSC(预分频寄存器)=1个周期内定时器可以记的数

当定时器的计数达到`TIM_ARR`的数值时，发生定时器中断，执行中断函数，然后重新计数
...
整理[蓝桥杯知识点](https://github.com/simoonp/little-project/blob/main/%E8%93%9D%E6%A1%A5%E6%9D%AF.md)
